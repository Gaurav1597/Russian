    ...
    class LogicClass
    {
        ...
        {
            {
                if (Bullet == 1 && ShootingChances == 2)
                {
                    ...
                    points = 10;
                    MessageBox.Show("You alive! You got " + points + " points");
                    Application.Restart();
                ...
                else
                {
                    ...
                    {
                        MessageBox.Show("You lost your life, you scored " + points + " points do you want to play again?", "Game Over");
                        Application.Restart();
                    }
                    else
                    {
                        MessageBox.Show("All the best!! You have last chance to alive");
                    }
                }
            ...
            public int ShootAway()
        {
            if (Bullet == 1)
            {
                ...
                // the user is dead!
                MessageBox.Show("You are dead and you scored zero points! you wana play again?", "Game Over!");
                Application.Restart();
            }
            else
            {
                ...
                {
                    points = 10;
                    MessageBox.Show("You win! Congrats! You got " + points + " points! you wana play again?", "Game Over!");
                    Application.Restart();
                }
                else if (ShootingAwayChances == 0 && ShootingChances == 1)
                {
                    points = 5;
                    MessageBox.Show("You Alive!!! Congrats! You got " + points + " points! you wana play again?", "Game Over!");
                    Application.Restart();
                }
                else
                {
